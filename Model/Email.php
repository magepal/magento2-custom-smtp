...
class Email
{
    const XML_PATH_EMAIL_TEMPLATE_ZEND_TEST  = 'magepal_custom_smtp/general/zend_email_template';

    const XML_PATH_EMAIL_TEMPLATE_MAGENTO_TEST  = 'magepal_custom_smtp/general/magento_email_template';
