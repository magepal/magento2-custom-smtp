...
[![Total Downloads](https://poser.okvpn.org/magepal/magento2-custom_smtp/downloads)](https://www.magepal.com/magento2/extensions/custom-smtp.html)
[![Latest Stable Version](https://poser.okvpn.org/magepal/magento2-custom_smtp/v/stable)](https://www.magepal.com/magento2/extensions/custom-smtp.html)
...
The custom SMTP extension for Magento 2 is a software add-on that allows you to use an external SMTP (Simple Mail Transfer Protocol) server to send emails from your Magento 2 store. 
This extension provides more flexibility and control over the email delivery process, as well as improved deliverability and reliability compared to using the default email server. 
With this extension, you can specify custom SMTP settings such as the server host, port, username, password, and encryption method, as well as set up email templates and test email configurations. 
This extension is ideal for Magento 2 store owners who need to send emails to customers or other stakeholders, and want to ensure that their emails are delivered quickly, securely, and effectively.
...
```sh
composer require magepal/magento2-custom-smtp
```
